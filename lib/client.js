...
var AdvisorCard = React.memo(function AdvisorCard2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, minWidth: 150 } }), /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "Comma-separated substrings matched against the session's workspace path; this advisor only runs in matching sessions. Leave empty for every session. The Workspaces tab offers a per-workspace toggle matrix over the same field.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, minWidth: 150 } }, "Skills (", skills.length, ")"), /* @__PURE__ */ React.createElement(
      "select",
      {
...
function pollOnce() {
  ...
  connection.rpc.call("/dsh-omp-advisor", "snapshot", {}).then((result) => {
...
function AdvisorsMonitorTab() {
  const snapshot = useSnapshot();
  const sessions = snapshot?.sessions ?? [];
  const events = snapshot?.recentEvents ?? [];
  return /* @__PURE__ */ React2.createElement("div", { style: panel }, sessions.length === 0 ? /* @__PURE__ */ React2.createElement("div", { style: cardStyle }, /* @__PURE__ */ React2.createElement("strong", null, "No advisor sessions"), /* @__PURE__ */ React2.createElement("span", { style: hint }, "Advisors attach to sessions when the plugin is enabled (Settings \u2192 OMP Advisor \u2192 General) and a session matches an advisor's workspace patterns.")) : sessions.map((session) => /* @__PURE__ */ React2.createElement("div", { key: session.sessionId, style: cardStyle }, /* @__PURE__ */ React2.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React2.createElement("strong", { title: session.sessionId }, "Session ", session.sessionId.slice(0, 8)), /* @__PURE__ */ React2.createElement("span", { style: hint }, session.active ? "attached" : "detached"), typeof session.restorePoints === "number" && session.restorePoints > 0 && /* @__PURE__ */ React2.createElement("span", { style: chip }, session.restorePoints, " restore points")), session.advisors.length === 0 ? /* @__PURE__ */ React2.createElement("span", { style: hint }, "No advisors matched this session's workspace.") : session.advisors.map((advisor) => /* @__PURE__ */ React2.createElement(
    "div",
    {
      key: advisor.name,
  ...
  )))), /* @__PURE__ */ React2.createElement("div", { style: cardStyle }, /* @__PURE__ */ React2.createElement("strong", null, "Activity"), events.length === 0 ? /* @__PURE__ */ React2.createElement("span", { style: hint }, "No advisor activity yet this server run.") : /* @__PURE__ */ React2.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, events.slice(0, 60).map((event, index) => /* @__PURE__ */ React2.createElement("div", { key: `${event.time}-${index}`, style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React2.createElement("span", { style: { ...hint, fontVariantNumeric: "tabular-nums" } }, formatTime(event.time)), /* @__PURE__ */ React2.createElement(
    "span",
    {
      style: {
        ...chip,
    ...
    const tryRegister = () => {
      ...
      try {
        unregister = service.registerTab({
          ...
          single: true,
          badge,
          component: () => React2.createElement(AdvisorsMonitorTab)
        });
