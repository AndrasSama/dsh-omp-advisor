...
function createSettingsSection(ctx) {
  return function OmpAdvisorSettingsSection() {
      ...
      const poll = () => {
        ctx.connection.rpc.call("/dsh-omp-advisor", "snapshot", {}).then((result) => {
          ...
          if (pendingRef.current > 0 || draftRef.current !== null) {
            setView((current) => current ? { ...current, sessions: value2.sessions } : value2);
            return;
          }
    ...
    return /* @__PURE__ */ React.createElement("div", { style: styles.root }, writeError && /* @__PURE__ */ React.createElement("div", { style: styles.hint }, "Settings write failed: ", writeError), /* @__PURE__ */ React.createElement("div", { style: styles.card }, /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("label", { style: styles.label }, /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, opacity: 0.75 } }, "attempts")), /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: styles.label }), /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "Failed advisor reviews re-run after the delay; a failed primary-model turn receives an automatic \u201Ccontinue\u201D message. User aborts and permanent errors (unknown model/provider) never retry.")), /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: styles.label }, "Skip tiny deltas (chars)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: 0,
      ...
      ADVISOR_PRESETS.map((preset) => /* @__PURE__ */ React.createElement("option", { key: preset.id, value: preset.id, title: preset.description }, preset.name, " \xB7 ", preset.role))
    ), /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "Presets create a ready-made advisor with an expanded persona and 10 curated skills.")), catalogError && /* @__PURE__ */ React.createElement("div", { style: styles.hint }, "Model list unavailable: ", catalogError), advisors.map((entry, index) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        (() => {
          ...
          return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, minWidth: 150 } }, "Skills (", skills.length, ")"), /* @__PURE__ */ React.createElement(
            "select",
            {
              ...
              onChange: (event) => updateAdvisor(index, { skillMode: event.target.value === "lazy" ? "lazy" : "inject" })
            },
            ...
            return /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                "button",
                {
                  ...
                  onClick: () => updateAdvisor(index, { skills: skills.filter((id) => id !== skillId) })
                },
                "\xD7"
              )
            );
            ...
            available.map((item) => /* @__PURE__ */ React.createElement("option", { key: item.id, value: item.id, title: item.description }, item.id))
          ));
        })()
      );
      ...
      ": ",
      advisor.lastError
    ))))), /* @__PURE__ */ React.createElement("div", { style: styles.hint }, `Advice semantics ported from oh-my-pi (can1357/oh-my-pi, MIT). Advisors investigate with read-only tools and deliver notes as <advisory guidance="weigh, don't blindly obey"> \u2014 the primary agent decides what to do with them.`));
  };
}
