...
// src/client/SettingsSection.tsx
var { useCallback, useEffect, useMemo, useState, useSyncExternalStore } = React;
var styles = {
...
function createSettingsSection(ctx) {
  ...
  return function OmpAdvisorSettingsSection() {
    const snapshot = useSyncExternalStore(
      useCallback((cb) => scope.subscribe(cb), [scope]),
    ...
    if (snapshot.status === "unavailable" || !value) {
      return /* @__PURE__ */ React.createElement("div", { style: styles.root }, /* @__PURE__ */ React.createElement("div", { style: styles.card }, /* @__PURE__ */ React.createElement("strong", null, "Advisor settings unavailable"), /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "The dsh-omp-advisor host service is not mounted. Restart DSH after installing the plugin.")));
    }
    const severities = value.interruptSeverities ?? ["concern", "blocker"];
    return /* @__PURE__ */ React.createElement("div", { style: styles.root }, /* @__PURE__ */ React.createElement("div", { style: styles.card }, /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("label", { style: styles.label }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "checkbox",
    ...
    }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", { style: styles.button, onClick: addAdvisor }, "+ Add advisor"))), /* @__PURE__ */ React.createElement("div", { style: styles.card }, /* @__PURE__ */ React.createElement("strong", null, "Live status"), !status || !status.sessions || status.sessions.length === 0 ? /* @__PURE__ */ React.createElement("span", { style: styles.hint }, value.enabled ? "No sessions with attached advisors yet. Start a session and advisors will attach." : "Advisors are disabled.") : status.sessions.map((session) => /* @__PURE__ */ React.createElement("div", { key: session.sessionId, style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "session ", session.sessionId), /* @__PURE__ */ React.createElement("div", { style: styles.row }, session.advisors.map((advisor) => /* @__PURE__ */ React.createElement("span", { key: advisor.name, style: styles.chip, title: advisor.lastError ?? "" }, /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          width: 8,
