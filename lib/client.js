...
function AdvisorsMonitorTab(props) {
  ...
  return /* @__PURE__ */ React2.createElement("div", { style: panel }, sessions.length === 0 ? /* @__PURE__ */ React2.createElement("div", { style: cardStyle }, /* @__PURE__ */ React2.createElement("strong", null, "No advisor sessions"), /* @__PURE__ */ React2.createElement("span", { style: hint }, "Advisors attach to sessions when the plugin is enabled (Settings \u2192 Ward Council \u2192 General) and a session matches an advisor's workspace patterns.")) : sessions.map(renderSessionCard), /* @__PURE__ */ React2.createElement("div", { style: cardStyle }, /* @__PURE__ */ React2.createElement("strong", null, "Activity"), events.length === 0 ? /* @__PURE__ */ React2.createElement("span", { style: hint }, "No advisor activity yet this server run.") : /* @__PURE__ */ React2.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, events.slice(0, 60).map((event, index) => /* @__PURE__ */ React2.createElement("div", { key: `${event.time}-${index}`, style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React2.createElement("span", { style: { ...hint, fontVariantNumeric: "tabular-nums" } }, formatTime(event.time)), /* @__PURE__ */ React2.createElement(
    "span",
    {
      style: {
        ...chip,
