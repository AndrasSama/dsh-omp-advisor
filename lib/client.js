...
var AdvisorCard = React.memo(function AdvisorCard2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, minWidth: 150 } }), /* @__PURE__ */ React.createElement("span", { style: styles.hint }, "Comma-separated patterns matched against the session's workspace path; this advisor only runs in matching sessions (empty = every session). A pattern is a SUBSTRING match \u2014 '/home/sama' also matches '/home/sama/anything'. Prefix a pattern with '=' for an EXACT path match, e.g. '=/home/sama'. The Workspaces tab offers a per-workspace toggle matrix over the same field.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: styles.row }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.hint, minWidth: 150 } }, "Skills (", skills.length, ")"), /* @__PURE__ */ React.createElement(
      "select",
      {
