...
var DEFAULT_ADVISOR_TOOL_NAMES = /* @__PURE__ */ new Set(["read", "grep", "glob", "advise", "load_skill"]);
...
var advisorSettingsSchema = z.object({
  ...
  autoRetryMax: z.number().min(1).max(10).default(3).description("Max auto-retry attempts per failed advisor review, and per primary-model failure episode."),
